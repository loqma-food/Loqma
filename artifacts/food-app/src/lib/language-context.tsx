...
const copy = {
  en: {
    ...
    finished: 'Finished', exit: 'Exit', pause: 'Pause', resume: 'Resume', resetTimer: 'Reset timer', cookingMode: 'Cooking mode',
  ...
  ar: {
    ...
    finished: 'خلصت', exit: 'خروج', pause: 'إيقاف مؤقت', resume: 'استكمال', resetTimer: 'إعادة المؤقت', cookingMode: 'وضع الطبخ',
