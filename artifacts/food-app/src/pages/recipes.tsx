  ...
  return <SavorlyShell showChef>
    <div className="mx-auto max-w-6xl px-5 pb-32 md:px-8 md:pb-16">
      ...
      <section className="relative z-10 -mt-6 space-y-3 px-1">
        ...
        {filtersOpen && <div className="animate-rise-in grid gap-3 rounded-[1.5rem] border border-border bg-card p-4 shadow-md sm:grid-cols-2 md:grid-cols-3" data-testid="panel-recipe-filters">
